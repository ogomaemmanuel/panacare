    ...
    return Column(
      children: [
        ...
        const Padding(
          ...
          child: Row(
            children: [
              Expanded(child: Text("By continuing you confirm that you are authorised to use this phone number and agree to receive an SMS text "))
            ],
          ),
        )
      ],
    ...
    return Column(
      children: [
        ...
        const Padding(
          ...
          child: Row(
            children: [
              Flexible(child: Text("Enter the four digit activation code sent to your email and mobile number"))
            ],
          ),
        ),
        ...
        GestureDetector(
          child: Row(
            ...
            children: [ Padding(
              padding: const EdgeInsets.only(top:24.0),
              child: const Text("Resend code?",style: TextStyle(decoration: TextDecoration.underline, color: Colors.black)),
            )],
          ),
        )
      ],
